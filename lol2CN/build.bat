...
@rem exe
jpackage --name lol2Chinese --input E:\game-help-script\lol2CN\src\out\target --main-jar Home.jar --java-options "-Djpackager.useUPX=false" --main-class gui.Home --type app-image --runtime-image myruntime --vendor "火花spk" --copyright "copyright 2025" --app-version 1.5 --verbose
